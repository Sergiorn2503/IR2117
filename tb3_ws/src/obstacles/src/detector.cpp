...
double obs_angle_min; double obs_angle_max; double obs_threshold;
...
int main(int argc, char * argv[])
{
    ...
    publisher = node->create_publisher<example_interfaces::msg::Bool>("obstacle", 10); //Sin / inicial para dividirlo
